/**
 * MIRROR — this file is a copy of lib/legal.ts in the InSpiritInTruth website
 * repo, which is the canonical home of these documents. The pages here set
 * their canonical URL to inspiritintruth.net so search engines treat that copy
 * as primary. If you edit one, edit both.
 */
/**
...
export const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "PostHog also counts visits to the InSpiritInTruth website — which pages are read, which site the visit came from, how quickly the page loaded, errors the page hits, and a short list of named taps: the app store badges, the 'Get the app' button, our Instagram and TikTok links, the contact link, and whether a gift was started and completed, with its amount (never the giver's name or email address). It never records the text of what you tap. On the website it runs without cookies of any kind: nothing is stored in your browser, nothing follows you between visits, and there is no consent banner because there is nothing to consent to.",
