...
export const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "PostHog also counts visits to the InSpiritInTruth website — which pages are read, and whether anyone taps through to an app store. On the website it runs without cookies of any kind: nothing is stored in your browser, nothing follows you between visits, and there is no consent banner because there is nothing to consent to.",
